...
<?php
    ...
    $kinepolise = new PDO('mysql:dbname=kinepolise;host=localhost', 'root', '');
        ...
        if ($kinepolise->exec('INSERT INTO seance_cinema1 (FilmName, DateSeanceBegin, DateSeanceEnd, SalleName, Nombre_de_place) VALUES ("'. $_POST['FilmName'] . '", "' . $fusionDateBegin . '", "' . $fusionDateEnd . "' . $_POST['SalleName'] .'", "' . $_POST['Nombre_de_place'] .'");') !== false) {
