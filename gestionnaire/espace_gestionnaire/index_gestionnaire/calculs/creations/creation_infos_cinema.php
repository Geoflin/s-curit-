...
foreach ($pdo->query('SELECT SalleName FROM `infos_cinema1` WHERE `SalleName` = "'.$_POST['SalleName'].'" ', PDO::FETCH_ASSOC) as $infos_cinema1) {
  $infos_cinema1_double[]= $infos_cinema1_double['SalleName'];
    ...
    $countInfo_Salle_double= count($infos_cinema1_double);
                ...
                if ($pdo->exec('INSERT INTO infos_cinema1 (SalleName, Nombre_de_place) VALUES ("'. $_POST['SalleName'] . '", "' . $_POST['Nombre_de_place'] .'");') !== false){};
                } else {
