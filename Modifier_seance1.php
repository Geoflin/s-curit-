<?php
                             ...
                             $Id= implode("", $_POST['Id']);
                                 ...
                                 $conn->exec("SET CHARACTER SET utf8");
                                         ...
                                         $sql = "UPDATE `seance_cinema1` SET `FilmName` = '".$_POST['FilmName']."', `DateSeanceBegin` = '".$fusionDateBegin."', '' = '".$fusionDateEnd."', `DateSeanceEnd` = '".$DateSeanceEnd."', `SalleName` = '".$_POST['SalleName']."' WHERE `seance_cinema1`.`Id` = '".$Id."' ";
                                         $count = $conn->exec($sql);
