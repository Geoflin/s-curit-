<HTML>
    ...
    foreach ($pdo->query('SELECT * FROM seance_cinema1', PDO::FETCH_ASSOC) as $seance) { 
        ...
        <td id="Colonne3"><?php echo $seance['DateSeanceBegin']->format('Y-m-d');?><div id="div"><input type="date"  name="DateSeanceBegin"  id="DateSeanceBegin" classe="modifier" placeholder="<?php echo $seance['DateSeanceBegin']->format('Y-m-d');?>" value="<?php $seance['DateSeanceBegin']->format('Y-m-d') ?>"></div></td>
        <td id="Colonne4"><?php echo $seance['HourBegin']->format('H:i:s');?></br><div id="div"><input type="time" name="HourBegin" id="HourBegin" classe="modifier" placeholder="<?php echo $seance['HourBegin']->format('H:i:s');?>" value="<?php $seance['HourBegin']->format('H:i:s'); ?>"></div></td>
        <td id="Colonne5"><?php echo $seance['DateSeanceEnd']->format('H:i:s');?></br><div id="div"><input type="time"  name="HourEnd" id="HourEnd" classe="modifier" placeholder="<?php echo $seance['DateSeanceEnd']->format('H:i:s');?>" value="<?php echo $seance['DateSeanceEnd']->format('H:i:s');?>"></div></td>
